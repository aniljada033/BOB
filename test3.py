...
def update_clock():
    ...
    for i in range(12):
        ...
        if i == 0:
            x = WIDTH / 2  # Corrected the x coordinate for the number 12
            y = HEIGHT / 2 - 0.7 * WIDTH / 2  # Corrected the y coordinate for the number 12
    ...
    for i in range(60):
        ...
        x1 = WIDTH / 2 + 0.8 * WIDTH / 2 * math.cos(angle)  # Moved the x1, y1, x2, y2 calculations inside the loop
...
# Initial call to update the clock function
update_clock()
root.mainloop()
